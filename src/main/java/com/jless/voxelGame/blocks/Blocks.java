...
public class Blocks {
  ...
  static {
    ...
    TEX_FRONT[BlockID.GRASS & 0xFF] = (TextureAtlas.tile(2, 11));
    ...
    TEX_FRONT[BlockID.DIRT & 0xFF] = (TextureAtlas.tile(3, 11));
    ...
    TEX_FRONT[BlockID.STONE & 0xFF] = (TextureAtlas.tile(0, 11));
    ...
    TEX_FRONT[BlockID.COBBLE & 0xFF] = (TextureAtlas.tile(0, 10));
    ...
    TEX_FRONT[BlockID.OAK_LOG & 0xFF] = (TextureAtlas.tile(4, 10));
    ...
    TEX_FRONT[BlockID.OAK_PLANK & 0xFF] = (TextureAtlas.tile(4, 11));
    ...
    TEX_FRONT[BlockID.OAK_LEAVES & 0xFF] = (TextureAtlas.tile(6, 6));
    ...
    TEX_FRONT[BlockID.SPRUCE_PLANK & 0xFF] = (TextureAtlas.tile(6, 7));
    ...
    TEX_FRONT[BlockID.SPRUCE_LOG & 0xFF] = (TextureAtlas.tile(4, 7));
    ...
    TEX_FRONT[BlockID.GLASS & 0xFF] = (TextureAtlas.tile(3, 10));
    ...
    TEX_FRONT[BlockID.IRON_ORE & 0xFF] = (TextureAtlas.tile(1, 0));
    ...
    TEX_FRONT[BlockID.COAL_ORE & 0xFF] = (TextureAtlas.tile(10, 11));
    ...
    TEX_FRONT[BlockID.DIAMOND_ORE & 0xFF] = (TextureAtlas.tile(0, 10));
    ...
    TEX_FRONT[BlockID.COPPER_ORE & 0xFF] = (TextureAtlas.tile(11, 11));
    ...
    TEX_FRONT[BlockID.SAND & 0xFF] = (TextureAtlas.tile(2, 10));
    ...
    TEX_FRONT[BlockID.IRON_BLOCK & 0xFF] = (TextureAtlas.tile(1, 7));
    ...
    TEX_FRONT[BlockID.COPPER_BLOCK & 0xFF] = (TextureAtlas.tile(2, 7));
    ...
    TEX_FRONT[BlockID.COAL_BLOCK & 0xFF] = (TextureAtlas.tile(9, 9));
    ...
    TEX_FRONT[BlockID.DIAMOND_BLOCK & 0xFF] = (TextureAtlas.tile(0, 7));
    TEX_SIDE[BlockID.DIAMOND_BLOCK & 0xFF] = (TextureAtlas.tile(0, 7));

    SOLID[BlockID.FURNACE & 0xFF] = true;
    TEX_TOP[BlockID.FURNACE & 0xFF] = (TextureAtlas.tile(8, 3));
    TEX_BOTTOM[BlockID.FURNACE & 0xFF] = (TextureAtlas.tile(8, 3));
    TEX_FRONT[BlockID.FURNACE & 0xFF] = (TextureAtlas.tile(10, 3));
    TEX_SIDE[BlockID.FURNACE & 0xFF] = (TextureAtlas.tile(9, 3));
